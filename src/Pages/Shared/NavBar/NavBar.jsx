...
const NavBar = () => {
  ...
  return (
    <nav className="bg-white shadow-sm px-6 lg:px-16 py-4 rounded-2xl sticky top-0 z-50">
      <div className="flex justify-between items-center">
        ...
        <ul className="hidden lg:flex items-center gap-8 text-sm font-medium text-gray-600">
          ...
          {user && <li><Link to="/dashboard" className="hover:text-gray-900">Dashboard</Link></li>}
        </ul>
      ...
      {isOpen && (
        <div className="lg:hidden mt-4 space-y-4">
          <ul className="flex flex-col gap-4 text-gray-600 font-medium">
            ...
            <li><Link to="/sendParcel" onClick={toggleMenu} className="hover:text-gray-900">Send Parcel</Link></li>
            {user && (
              <li><Link to="/dashboard" onClick={toggleMenu} className="hover:text-gray-900">Dashboard</Link></li>
            )}
          </ul>
            ...
            {user ? (
              <>
                ...
                <button
                  ...
                  className="px-4 py-2 text-red-500 border border-red-400 rounded-full hover:bg-red-50 transition"
                >
                  Logout
                </button>
              </>
