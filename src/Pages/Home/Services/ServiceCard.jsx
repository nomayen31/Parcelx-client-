...
const ServiceCard = ({ title, description, highlight }) => {
  ...
  const iconMap = {
    ...
    "Cash On Delivery": <FaMoneyBillWave className="text-[#0a4d46] text-5xl" />,
  ...
  return (
    <div
      className={`p-8 text-center rounded-3xl shadow-lg transition-transform transform hover:-translate-y-1 ${cardBgClass} h-full`}
    >
